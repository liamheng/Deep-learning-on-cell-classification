...
ScratchModel.py trains a CNN model from scratch for cell classification.![alt text](https://github.com/lihengbit/Deep-learning-on-cell-classification/blob/master/ScratchStructure.png)
