...
TestX=TestX.reshape(TestX.shape[0]*TestX.shape[1],224,224,1)
...
history=model.fit(TrainX, TrainY,epochs=5000,batch_size=100,verbose=1,callbacks=[saveBestModel,earlyStopping],validation_data=(TestX, TestY))
